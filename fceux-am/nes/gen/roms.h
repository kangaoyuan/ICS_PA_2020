extern const unsigned char rom_stargate_nes[];
extern unsigned int rom_stargate_nes_len;
extern const unsigned char rom_mario_nes[];
extern unsigned int rom_mario_nes_len;
extern const unsigned char rom_karateka_nes[];
extern unsigned int rom_karateka_nes_len;
extern const unsigned char rom_lunarpool_nes[];
extern unsigned int rom_lunarpool_nes_len;
extern const unsigned char rom_tetris_nes[];
extern unsigned int rom_tetris_nes_len;
extern const unsigned char rom_skydestroyer_nes[];
extern unsigned int rom_skydestroyer_nes_len;
extern const unsigned char rom_exerion_nes[];
extern unsigned int rom_exerion_nes_len;
extern const unsigned char rom_circus_nes[];
extern unsigned int rom_circus_nes_len;
extern const unsigned char rom_castlevania_nes[];
extern unsigned int rom_castlevania_nes_len;
extern const unsigned char rom_balloon_nes[];
extern unsigned int rom_balloon_nes_len;
extern const unsigned char rom_pinball_nes[];
extern unsigned int rom_pinball_nes_len;
extern const unsigned char rom_f1_nes[];
extern unsigned int rom_f1_nes_len;
extern const unsigned char rom_bomberman_nes[];
extern unsigned int rom_bomberman_nes_len;
extern const unsigned char rom_spartanx_nes[];
extern unsigned int rom_spartanx_nes_len;
extern const unsigned char rom_kungfu_nes[];
extern unsigned int rom_kungfu_nes_len;
extern const unsigned char rom_battlecity_nes[];
extern unsigned int rom_battlecity_nes_len;
extern const unsigned char rom_mario3_nes[];
extern unsigned int rom_mario3_nes_len;
extern const unsigned char rom_pacman_nes[];
extern unsigned int rom_pacman_nes_len;
extern const unsigned char rom_starforce_nes[];
extern unsigned int rom_starforce_nes_len;
extern const unsigned char rom_loderunner_nes[];
